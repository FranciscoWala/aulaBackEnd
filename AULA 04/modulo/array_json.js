...
const cadastroDeProdutos = function () {
    ...
    // console.log(produtos)
    //METE UM CONSOLE.LOG E VEJA OS SIMBOLOS, SE FOR JSON PONTO E O NOME DO ATRIBUTO

    // Fazendo diferente

    // O primeiro FOREACH permite percorrer e extrair os produtos
    // produtos.forEach(function (itemProduto) {

    //     console.log(`\nProduto: ${itemProduto.nome}`)
    //     //O segundo FOREACH permite percorrer e extrair as  marcas
    //     itemProduto.marca.forEach(function (itemMarca) {

    //         console.log(`   Marca: ${itemMarca}`)

    //     })
    //     //O terceiro FOREACH permite percorrer e extrair as cores de cada produto
